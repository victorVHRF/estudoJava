							...
							<div class="col-md-8">
								<div class="form-group">
									<label>Nome</label> <input type="text"
										value='${usuario.userName}' name="userName" id="userName"
										placeholder="Informe o Nome" required class="form-control">
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
									<label>Login</label> <input type="text"
										value='${usuario.userLogin}' name="userLogin" id="userLogin"
										placeholder="Informe o Login" required class="form-control">
								</div>
							</div>
						</div>
						<div class="row">
